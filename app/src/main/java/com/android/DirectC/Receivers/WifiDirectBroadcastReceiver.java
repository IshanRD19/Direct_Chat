...
public class WifiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    //Constructor (subroutine to create an object)
    ...
    public List<String> getPeersName() {
        ...
        //Sequenced collection of WiFi Peers names
    ...
    public List<WifiP2pDevice> getPeers() {
        ...
        //Sequenced collection of WiFi Peers
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION)) {
            ...
            //EXTRA_WIFI_STATE- Lookup key for an int that
            ...
            if (networkInfo.isConnected()) {
                mManager.requestConnectionInfo(mChannel, new ConnectionInfoListener() {
                    ...
                    public void onConnectionInfoAvailable(WifiP2pInfo info) {
                        ...
                        //The Group Owner : create a server thread and accept incoming connections
